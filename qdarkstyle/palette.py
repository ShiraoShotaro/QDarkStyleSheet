...
class DarkPalette(object):
    ...
    COLOR_SELECTION_LIGHT = '#71a6c9'
    COLOR_SELECTION_NORMAL = '#5285a6'
    COLOR_SELECTION_DARK = '#507893'
    ...
    BORDER_NORMAL = '1px solid $COLOR_BACKGROUND_LIGHT'
    BORDER_DARK = '1px solid $COLOR_BACKGROUND_DARK'

    BORDER_SELECTION_LIGHT = '2px solid $COLOR_SELECTION_LIGHT'
